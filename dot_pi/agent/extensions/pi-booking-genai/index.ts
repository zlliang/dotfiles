...
export default function (pi: ExtensionAPI) {
	pi.registerProvider(PROVIDER_ID, {
		...
		models: [
			{
				id: "ml-asset:static-model/claude-opus-4-8",
			...
			{
				id: "ml-asset:static-model/claude-opus-4-6",
			...
			{
				id: "ml-asset:static-model/claude-opus-4-5",
			...
			{
				id: "ml-asset:static-model/claude-sonnet-4-5",
